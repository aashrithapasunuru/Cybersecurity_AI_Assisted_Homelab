...
- `59855 → 40185` — SYN
- `59856 → 40185` — ACK
- `59857 → 40185` — FIN/URG-related flags

The changing source ports indicate these packets belong to separate TCP probes rather than a single TCP connection.

This provides packet-level evidence of reconnaissance activity generated by the Kali VM.
